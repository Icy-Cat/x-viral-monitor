  ...
  "rules": [
    {
      ...
      "type": "regex",
      "field": "content",
      "value": "(t\\.me|telegram|电报|飞机).{0,32}(中推|中文推特|福利(资源|视频|社群|社区|导航|群|频道)|成人(资源|视频)|成人视频|私信(加入|加群|进群|领取|获取)|加(群|频道)|进群|群里.{0,8}(福利|资源|视频|约|广告)|频道.{0,8}(福利|资源|视频|广告)|同城.{0,8}(线下|上门|可约)|线下.{0,8}(约|上门|见面)|上门|约P|约炮|曰泡|宝宝.{0,6}(点这里|主页|私信))",
      "severity": "block"
    },
    {
